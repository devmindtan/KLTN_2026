...
import {
  IconTarget, IconBrain, IconCircleCheck, IconChartLine,
  IconTrendingUp, IconDatabase, IconShieldCheck, IconCamera,
...
interface OverviewStatsProps {
  ...
  dataCoveragePending?: number;
}

export function OverviewStats({ metrics, dataCoveragePending = 0 }: OverviewStatsProps) {
    ...
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <StatCard
          ...
          sub1={<p className="text-[11px] text-muted-foreground mt-1">Chờ sync: {dataCoveragePending.toLocaleString("vi-VN")}</p>}

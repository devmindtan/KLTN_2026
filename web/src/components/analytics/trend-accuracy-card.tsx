...
import { IconTrendingUp, IconArrowUp, IconArrowDown, IconMinus } from "@tabler/icons-react";
...
export function TrendAccuracyCard({ trendAccuracy, periodDays }: TrendAccuracyCardProps) {
      ...
      <CardContent className="px-4 pb-4">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-3 col-span-1 sm:col-span-2">
            {trendAccuracy.per_horizon && trendAccuracy.per_horizon.length > 0 ? (() => {
              const horizonData = trendAccuracy.per_horizon!.find(h => h.horizon_minutes === selectedHorizon)

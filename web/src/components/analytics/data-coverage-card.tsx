      ...
      <CardContent className="px-4 pb-4">
        <div className="grid grid-cols-3 gap-4 mb-3">
          <div>
            ...
            <p className="text-xl font-bold tabular-nums">{dataCoverage.total_predictions.toLocaleString("vi-VN")}</p>
          </div>
          <div>
            <p className="text-[11px] text-muted-foreground">Đã xác minh</p>
            <p className="text-xl font-bold tabular-nums text-green-600 dark:text-green-400">{dataCoverage.verified.toLocaleString("vi-VN")}</p>
          </div>
          <div>
            <p className="text-[11px] text-muted-foreground">Chờ đồng bộ</p>
            <p className="text-xl font-bold tabular-nums text-yellow-600 dark:text-yellow-400">{dataCoverage.pending.toLocaleString("vi-VN")}</p>
          </div>
        </div>
